...
export default function WorryBankApp() {
  ...
  return (
    <div>
      {/* 모드 전환 탭 */}
      <div className="mb-3 flex gap-1.5 rounded-[14px] bg-[#ead9bd] p-1.5 ">
        <button
          onClick={() => setMode("statement")}
          className={`flex-1 rounded-[12px] px-4 py-2.5 text-sm font-bold transition ${
            mode === "statement"
              ? "bg-[#fff3df] text-slate-950 shadow-sm"
